...
python ./run_files/run_classification_bert.py --TASK sst2 --MAX_LENGTH 128 --DATA_SEED 22
python ./run_files/run_classification_bert.py --TASK mrpc --MAX_LENGTH 128 --DATA_SEED 22



python ./tools/store_saliencies.py --TASK sst2 --DATA_SEED 22 --MAX_LENGTH 64 --BATCH_SIZE 4
python ./tools/store_saliencies.py --TASK mrpc --DATA_SEED 22 --MAX_LENGTH 128 --BATCH_SIZE 64
